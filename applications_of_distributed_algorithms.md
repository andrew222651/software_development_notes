...
Ghosh - Distributed Systems (ch14.6) the idea is that if the work is a transaction,
...
Steen - Distributed Systems (§8.3.2) gives some terminology.
See also <https://docs.dbos.dev/python/tutorials/step-tutorial#transactions>.
the algorithm in Lee - Implementing Linearizability at Large Scale and Low Latency also uses durable storage
